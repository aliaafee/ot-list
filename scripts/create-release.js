...
archive.directory(
    join(projectRoot, "pb", "pb_migrations"),
    "pb/pb_migrations",
    {},
);
archive.directory(join(projectRoot, "pb", "pb_hooks"), "pb/pb_hooks", {});
archive.file(join(projectRoot, "pb_schema.json"), { name: "pb_schema.json" });
archive.file(join(projectRoot, "README.md"), { name: "README.md" });
archive.file(join(projectRoot, "scripts", "pocketbase.service"), {
    name: "scripts/pocketbase.service",
});
